    ...
    <>
      <div className='flex gap-4'>
        <button
          ...
          className='flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 hover:bg-black/50 bg-black/30 text-white'>
          Sign In
          <svg
            width='23'
            height='22'
        ...
        <button
          ...
          className='flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 text-white hover:bg-black/50 bg-black/30'>
          Sign In
          <svg
            width='22'
            height='22'
