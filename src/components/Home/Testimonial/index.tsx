    ...
    <section className='bg-cream py-20'>
      <div
        ...
        <div className='sm:flex justify-between items-center pb-6'>
          ...
          <div>
            <button className='bg-transparent hover:bg-primary text-primary font-semibold hover:text-white py-3 px-4 border border-primary hover:border-transparent rounded-sm duration-300'>
              Give Your Review
            </button>
          </div>
        </div>
