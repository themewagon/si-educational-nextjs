...
const Mentor = () => {
  return (
    <section className='py-20'>
      <div id='mentors-section' className='container mx-auto max-w-7xl px-4'>
        <div className='sm:flex justify-between items-center mb-12'>
          ...
          <div>
            <button className='bg-transparent hover:bg-primary text-primary font-medium hover:text-white py-3 px-4 border border-primary hover:border-transparent rounded-sm duration-300'>
