...
const Signin = () => {
  ...
  return (
    <>
      ...
      <span className="z-1 relative my-8 block text-center before:content-[''] before:absolute before:h-px before:w-40% before:bg-white/60 before:left-0 before:top-3 after:content-[''] after:absolute after:h-px after:w-40% after:bg-white/60 after:top-3 after:right-0">
